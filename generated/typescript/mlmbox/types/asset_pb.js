...
goog.exportSymbol('proto.mlmbox.types.Asset.List', null, global);
/**
 ...
 * @constructor
 */
proto.mlmbox.types.Asset.List = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.mlmbox.types.Asset.List.repeatedFields_, null);
};
goog.inherits(proto.mlmbox.types.Asset.List, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.mlmbox.types.Asset.List.displayName = 'proto.mlmbox.types.Asset.List';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.mlmbox.types.Asset.List.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.mlmbox.types.Asset.List.prototype.toObject = function(opt_includeInstance) {
  return proto.mlmbox.types.Asset.List.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.mlmbox.types.Asset.List} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.mlmbox.types.Asset.List}
 */
proto.mlmbox.types.Asset.List.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.mlmbox.types.Asset.List;
  return proto.mlmbox.types.Asset.List.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.mlmbox.types.Asset.List} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.mlmbox.types.Asset.List}
 */
proto.mlmbox.types.Asset.List.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.mlmbox.types.Asset.List.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.mlmbox.types.Asset.List.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.mlmbox.types.Asset.List} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.mlmbox.types.Asset.List.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.mlmbox.types.Asset.List.prototype.getItemsList = function() {
 ...
 * @return {!proto.mlmbox.types.Asset.List} returns this
*/
proto.mlmbox.types.Asset.List.prototype.setItemsList = function(value) {
 ...
 * @return {!proto.mlmbox.types.Asset}
 */
proto.mlmbox.types.Asset.List.prototype.addItems = function(opt_value, opt_index) {
 ...
 * @return {!proto.mlmbox.types.Asset.List} returns this
 */
proto.mlmbox.types.Asset.List.prototype.clearItemsList = function() {
