...
goog.exportSymbol('proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect', null, global);
...
goog.exportSymbol('proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity', null, global);
goog.exportSymbol('proto.mlmbox.types.Wallet.Processing.Id', null, global);
goog.exportSymbol('proto.mlmbox.types.Wallet.Processing.Id.UniqueFieldCase', null, global);
 ...
 * @constructor
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect.displayName = 'proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.mlmbox.types.Wallet.Processing.Id = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.mlmbox.types.Wallet.Processing.Id.oneofGroups_);
};
 ...
 * @constructor
 */
proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity.displayName = 'proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceMatrix.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      var value = /** @type {number} */ (reader.readUint32());
      msg.setTargetPositionId(value);
      break;
    case 3:
      var value = /** @type {number} */ (reader.readUint32());
      msg.setTargetTreeAccountEntityId(value);
      break;
    case 4:
      var value = /** @type {number} */ (reader.readUint32());
    ...
    case 5:
      var value = /** @type {number} */ (reader.readUint32());
      msg.setSourceTreeAccountEntityId(value);
      break;
    case 6:
      var value = /** @type {number} */ (reader.readUint32());
      msg.setLevel(value);
...
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceMatrix.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getTargetTreeAccountEntityId();
  if (f !== 0) {
    writer.writeUint32(
      3,
      f
  ...
  f = message.getSourceTreeAccountEntityId();
  if (f !== 0) {
    writer.writeUint32(
      5,
      f
 ...
 * @return {number}
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceMatrix.prototype.getTreeId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
 ...
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceMatrix.prototype.setTreeId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};


/**
 * optional uint32 target_position_id = 2;
 * @return {number}
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceMatrix.prototype.getTargetPositionId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceMatrix} returns this
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceMatrix.prototype.setTargetPositionId = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};


/**
 * optional uint32 target_tree_account_entity_id = 3;
 * @return {number}
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceMatrix.prototype.getTargetTreeAccountEntityId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceMatrix} returns this
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceMatrix.prototype.setTargetTreeAccountEntityId = function(value) {
  return jspb.Message.setProto3IntField(this, 3, value);
};


/**
 * optional uint32 source_position_id = 4;
 * @return {number}
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceMatrix.prototype.getSourcePositionId = function() {
 ...
 * @return {!proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceMatrix} returns this
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceMatrix.prototype.setSourcePositionId = function(value) {
  return jspb.Message.setProto3IntField(this, 4, value);
};


/**
 * optional uint32 source_tree_account_entity_id = 5;
 * @return {number}
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceMatrix.prototype.getSourceTreeAccountEntityId = function() {
 ...
 * @return {!proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceMatrix} returns this
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceMatrix.prototype.setSourceTreeAccountEntityId = function(value) {
 ...
 * @return {!Object}
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect.prototype.toObject = function(opt_includeInstance) {
  return proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect}
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect;
  return proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect}
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTreeId();
  if (f !== 0) {
    writer.writeUint32(
 ...
 * @return {number}
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect.prototype.getTreeId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect} returns this
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect.prototype.setTreeId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect.prototype.getAccountId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect} returns this
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect.prototype.setAccountId = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {number}
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect.prototype.getPositionId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect} returns this
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect.prototype.setPositionId = function(value) {
  return jspb.Message.setProto3IntField(this, 3, value);
};
 ...
 * @return {number}
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect.prototype.getTreeAccountEntityId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};
 ...
 * @return {!proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect} returns this
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect.prototype.setTreeAccountEntityId = function(value) {
  return jspb.Message.setProto3IntField(this, 4, value);
};
...
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.prototype.setDescription = function(value) {
  return jspb.Message.setOneofField(this, 2, proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.oneofGroups_[0], value);
};
...
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.prototype.clearDescription = function() {
  return jspb.Message.setOneofField(this, 2, proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.oneofGroups_[0], undefined);
};
...
/**
 * optional SourceMatrix matrix = 3;
 * @return {?proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceMatrix}
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.prototype.getMatrix = function() {
  return /** @type{?proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceMatrix} */ (
    jspb.Message.getWrapperField(this, proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceMatrix, 3));
};
...
/**
 * optional SourceDirect direct = 4;
 * @return {?proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect}
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.prototype.getDirect = function() {
  return /** @type{?proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect} */ (
    jspb.Message.getWrapperField(this, proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect, 4));
};


/**
 * @param {?proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.SourceDirect|undefined} value
 * @return {!proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus} returns this
*/
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.prototype.setDirect = function(value) {
 ...
 * @return {!proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus} returns this
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus.prototype.clearDirect = function() {
...
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.prototype.getDeposit = function() {
  return /** @type{?proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Deposit} */ (
    jspb.Message.getWrapperField(this, proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Deposit, 2));
};
...
/**
 * optional Withdrawal withdrawal = 3;
 * @return {?proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Withdrawal}
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.prototype.getWithdrawal = function() {
  return /** @type{?proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Withdrawal} */ (
    jspb.Message.getWrapperField(this, proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Withdrawal, 3));
};
...
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.prototype.setWithdrawal = function(value) {
  return jspb.Message.setOneofWrapperField(this, 3, proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.oneofGroups_[0], value);
};
...
/**
 * optional uint32 keeper_booking_tree_id = 4;
 * @return {number}
 */
...
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.prototype.setKeeperBookingTreeId = function(value) {
  return jspb.Message.setOneofField(this, 4, proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.oneofGroups_[0], value);
};
...
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.prototype.clearKeeperBookingTreeId = function() {
  return jspb.Message.setOneofField(this, 4, proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.oneofGroups_[0], undefined);
};
...
/**
 * optional uint32 keeper_initial_tree_id = 5;
 * @return {number}
 */
...
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.prototype.setKeeperInitialTreeId = function(value) {
  return jspb.Message.setOneofField(this, 5, proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.oneofGroups_[0], value);
};
...
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.prototype.clearKeeperInitialTreeId = function() {
  return jspb.Message.setOneofField(this, 5, proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.oneofGroups_[0], undefined);
};
...
/**
 * optional PositionHeader keeper_reinvest = 6;
 * @return {?proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.PositionHeader}
 */
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.prototype.getKeeperReinvest = function() {
  return /** @type{?proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.PositionHeader} */ (
    jspb.Message.getWrapperField(this, proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.PositionHeader, 6));
};
...
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.prototype.setKeeperReinvest = function(value) {
  return jspb.Message.setOneofWrapperField(this, 6, proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.oneofGroups_[0], value);
};
...
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.prototype.getBonus = function() {
  return /** @type{?proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus} */ (
    jspb.Message.getWrapperField(this, proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.Bonus, 8));
};
...
/**
 * optional Account.Info account = 10;
...
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.prototype.getAccount = function() {
  return /** @type{?proto.mlmbox.types.Account.Info} */ (
    jspb.Message.getWrapperField(this, mlmbox_types_account_pb.Account.Info, 10));
};
...
/**
 * optional uint32 transaction_id = 11;
 * @return {number}
 */
...
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.prototype.setTransactionId = function(value) {
  return jspb.Message.setOneofField(this, 11, proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.oneofGroups_[0], value);
};
...
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.prototype.clearTransactionId = function() {
  return jspb.Message.setOneofField(this, 11, proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.oneofGroups_[0], undefined);
};
...
/**
 * optional Asset.Amount amount = 12;
...
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.prototype.getAmount = function() {
  return /** @type{?proto.mlmbox.types.Asset.Amount} */ (
    jspb.Message.getWrapperField(this, mlmbox_types_asset_pb.Asset.Amount, 12));
};
...
proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.prototype.setAmount = function(value) {
  return jspb.Message.setOneofWrapperField(this, 12, proto.mlmbox.types.Wallet.Asset.Transaction.Metadata.oneofGroups_[0], value);
};
...
/**
 * optional bool settings_transfer_enabled = 5;
 * @return {boolean}
 */
...
/**
 * optional string settings_transfer_limit_min = 6;
 * @return {string}
 */
 ...
 * @const
 */
proto.mlmbox.types.Wallet.Processing.Id.oneofGroups_ = [[1,2]];

/**
 * @enum {number}
 */
proto.mlmbox.types.Wallet.Processing.Id.UniqueFieldCase = {
  UNIQUE_FIELD_NOT_SET: 0,
  PROCESSING_ID: 1,
  PROCESSING_NAME: 2
};
...
/**
 * @return {proto.mlmbox.types.Wallet.Processing.Id.UniqueFieldCase}
 */
proto.mlmbox.types.Wallet.Processing.Id.prototype.getUniqueFieldCase = function() {
  return /** @type {proto.mlmbox.types.Wallet.Processing.Id.UniqueFieldCase} */(jspb.Message.computeOneofCase(this, proto.mlmbox.types.Wallet.Processing.Id.oneofGroups_[0]));
};
...
proto.mlmbox.types.Wallet.Processing.Id.prototype.setProcessingId = function(value) {
  return jspb.Message.setOneofField(this, 1, proto.mlmbox.types.Wallet.Processing.Id.oneofGroups_[0], value);
};
 ...
 * @return {!proto.mlmbox.types.Wallet.Processing.Id} returns this
 */
proto.mlmbox.types.Wallet.Processing.Id.prototype.clearProcessingId = function() {
  return jspb.Message.setOneofField(this, 1, proto.mlmbox.types.Wallet.Processing.Id.oneofGroups_[0], undefined);
};
 ...
 * @return {boolean}
 */
proto.mlmbox.types.Wallet.Processing.Id.prototype.hasProcessingId = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {string}
 */
proto.mlmbox.types.Wallet.Processing.Id.prototype.getProcessingName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.mlmbox.types.Wallet.Processing.Id} returns this
 */
proto.mlmbox.types.Wallet.Processing.Id.prototype.setProcessingName = function(value) {
  return jspb.Message.setOneofField(this, 2, proto.mlmbox.types.Wallet.Processing.Id.oneofGroups_[0], value);
};
 ...
 * @return {!proto.mlmbox.types.Wallet.Processing.Id} returns this
 */
proto.mlmbox.types.Wallet.Processing.Id.prototype.clearProcessingName = function() {
  return jspb.Message.setOneofField(this, 2, proto.mlmbox.types.Wallet.Processing.Id.oneofGroups_[0], undefined);
};
 ...
 * @return {boolean}
 */
proto.mlmbox.types.Wallet.Processing.Id.prototype.hasProcessingName = function() {
  return jspb.Message.getField(this, 2) != null;
};
...
proto.mlmbox.types.Wallet.Processing.Asset.Id.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.mlmbox.types.Wallet.Processing.Id;
      reader.readMessage(value,proto.mlmbox.types.Wallet.Processing.Id.deserializeBinaryFromReader);
      msg.setProcessingId(value);
      break;
    case 2:
...
proto.mlmbox.types.Wallet.Processing.Asset.Id.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.mlmbox.types.Wallet.Processing.Id.serializeBinaryToWriter
    );
  }
  f = message.getAssetId();
  if (f != null) {
...
/**
 * optional Id processing_id = 1;
 * @return {?proto.mlmbox.types.Wallet.Processing.Id}
 */
proto.mlmbox.types.Wallet.Processing.Asset.Id.prototype.getProcessingId = function() {
  return /** @type{?proto.mlmbox.types.Wallet.Processing.Id} */ (
    jspb.Message.getWrapperField(this, proto.mlmbox.types.Wallet.Processing.Id, 1));
};


/**
 * @param {?proto.mlmbox.types.Wallet.Processing.Id|undefined} value
 ...
 * @return {!proto.mlmbox.types.Wallet.Processing.Asset.Id} returns this
 */
proto.mlmbox.types.Wallet.Processing.Asset.Id.prototype.clearProcessingId = function() {
  return this.setProcessingId(undefined);
};
 ...
 * @return {boolean}
 */
proto.mlmbox.types.Wallet.Processing.Asset.Id.prototype.hasProcessingId = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional Asset.Id asset_id = 2;
 ...
 * @return {!proto.mlmbox.types.Wallet.Processing.Asset.Id} returns this
 */
proto.mlmbox.types.Wallet.Processing.Asset.Id.prototype.clearAssetId = function() {
 ...
 * @return {boolean}
 */
proto.mlmbox.types.Wallet.Processing.Asset.Id.prototype.hasAssetId = function() {
  return jspb.Message.getField(this, 2) != null;
};
...
proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity;
      reader.readMessage(value,proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity.deserializeBinaryFromReader);
      msg.addItems(value);
      break;
    default:
      reader.skipField();
...
proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity.prototype.toObject = function(opt_includeInstance) {
  return proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity}
 */
proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity;
  return proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity}
 */
proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getAddress();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity.prototype.getAddress = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity} returns this
 */
proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity.prototype.setAddress = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional uint32 last_used_at = 2;
 * @return {number}
 */
proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity.prototype.getLastUsedAt = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity} returns this
 */
proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity.prototype.setLastUsedAt = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {!Array<!proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity>}
 */
proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity, 1));
};


/**
 * @param {!Array<!proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity>} value
...
/**
 * @param {!proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity=} opt_value
 * @param {number=} opt_index
 * @return {!proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity}
 */
proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.prototype.addItems = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.mlmbox.types.Wallet.Processing.Asset.WithdrawalAddressHistory.Entity, opt_index);
};
