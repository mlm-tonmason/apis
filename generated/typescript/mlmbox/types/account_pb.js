...
goog.exportSymbol('proto.mlmbox.types.Matrix.TreeAccount.List', null, global);
 ...
 * @constructor
 */
proto.mlmbox.types.Matrix.TreeAccount.List = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.mlmbox.types.Matrix.TreeAccount.List.repeatedFields_, null);
};
goog.inherits(proto.mlmbox.types.Matrix.TreeAccount.List, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.mlmbox.types.Matrix.TreeAccount.List.displayName = 'proto.mlmbox.types.Matrix.TreeAccount.List';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.mlmbox.types.Account.Profile.toObject = function(includeInstance, msg) {
  var f, obj = {
    tgId: jspb.Message.getFieldWithDefault(msg, 1, 0),
...
proto.mlmbox.types.Account.Profile.prototype.getAva = function() {
  return /** @type{?proto.mlmbox.types.Account.Profile.Ava} */ (
    jspb.Message.getWrapperField(this, proto.mlmbox.types.Account.Profile.Ava, 2));
};
...
/**
 * repeated Matrix.TreeAccount matrix_tree_accounts = 2;
...
proto.mlmbox.types.Account.prototype.getMatrixTreeAccountsList = function() {
  return /** @type{!Array<!proto.mlmbox.types.Matrix.TreeAccount>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.mlmbox.types.Matrix.TreeAccount, 2));
};
...
proto.mlmbox.types.Account.prototype.addMatrixTreeAccounts = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.mlmbox.types.Matrix.TreeAccount, opt_index);
};
...
proto.mlmbox.types.Matrix.Tree.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    positionsQuantity: jspb.Message.getFieldWithDefault(msg, 3, 0),
    defaultPositionWidth: jspb.Message.getFieldWithDefault(msg, 4, 0),
...
/**
 * optional uint32 positions_quantity = 3;
 * @return {number}
 */
...
/**
 * optional uint32 default_position_width = 4;
 * @return {number}
 */
...
/**
 * optional Asset.Amount amount = 5;
 ...
 * @const
 */
proto.mlmbox.types.Matrix.TreeAccount.List.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.mlmbox.types.Matrix.TreeAccount.List.prototype.toObject = function(opt_includeInstance) {
  return proto.mlmbox.types.Matrix.TreeAccount.List.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.mlmbox.types.Matrix.TreeAccount.List} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.mlmbox.types.Matrix.TreeAccount.List.toObject = function(includeInstance, msg) {
  var f, obj = {
    itemsList: jspb.Message.toObjectList(msg.getItemsList(),
    proto.mlmbox.types.Matrix.TreeAccount.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.mlmbox.types.Matrix.TreeAccount.List}
 */
proto.mlmbox.types.Matrix.TreeAccount.List.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.mlmbox.types.Matrix.TreeAccount.List;
  return proto.mlmbox.types.Matrix.TreeAccount.List.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.mlmbox.types.Matrix.TreeAccount.List} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.mlmbox.types.Matrix.TreeAccount.List}
 */
proto.mlmbox.types.Matrix.TreeAccount.List.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.mlmbox.types.Matrix.TreeAccount.List.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.mlmbox.types.Matrix.TreeAccount.List.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.mlmbox.types.Matrix.TreeAccount.List} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.mlmbox.types.Matrix.TreeAccount.List.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getItemsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
 ...
 * @return {!Array<!proto.mlmbox.types.Matrix.TreeAccount>}
 */
proto.mlmbox.types.Matrix.TreeAccount.List.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.mlmbox.types.Matrix.TreeAccount>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.mlmbox.types.Matrix.TreeAccount, 1));
};


/**
 * @param {!Array<!proto.mlmbox.types.Matrix.TreeAccount>} value
 * @return {!proto.mlmbox.types.Matrix.TreeAccount.List} returns this
*/
proto.mlmbox.types.Matrix.TreeAccount.List.prototype.setItemsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 * @return {!proto.mlmbox.types.Matrix.TreeAccount}
 */
proto.mlmbox.types.Matrix.TreeAccount.List.prototype.addItems = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.mlmbox.types.Matrix.TreeAccount, opt_index);
};
 ...
 * @return {!proto.mlmbox.types.Matrix.TreeAccount.List} returns this
 */
proto.mlmbox.types.Matrix.TreeAccount.List.prototype.clearItemsList = function() {
  return this.setItemsList([]);
};
 ...
 * @return {number}
 */
proto.mlmbox.types.Matrix.Reinvest.prototype.getPositionId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.mlmbox.types.Matrix.Reinvest} returns this
 */
proto.mlmbox.types.Matrix.Reinvest.prototype.setPositionId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {boolean}
 */
proto.mlmbox.types.Matrix.Reinvest.prototype.getReinvestEnabled = function() {
 ...
 * @return {!proto.mlmbox.types.Matrix.Reinvest} returns this
 */
proto.mlmbox.types.Matrix.Reinvest.prototype.setReinvestEnabled = function(value) {
