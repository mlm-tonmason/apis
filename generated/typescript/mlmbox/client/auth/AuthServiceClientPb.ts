...
export class AuthClient {
  ...
  methodDescriptorTelegramWebLogin = new grpcWeb.MethodDescriptor(
    '/mlmbox.client.auth.Auth/TelegramWebLogin',
    grpcWeb.MethodType.UNARY,
    mlmbox_client_auth_auth_pb.TelegramWebLoginRequest,
    mlmbox_client_auth_auth_pb.AuthSignResponse,
    (request: mlmbox_client_auth_auth_pb.TelegramWebLoginRequest) => {
      return request.serializeBinary();
    },
    mlmbox_client_auth_auth_pb.AuthSignResponse.deserializeBinary
  );
  ...
  telegramWebLogin(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        ...
        request,
        metadata || {},
        this.methodDescriptorTelegramWebLogin,
        callback);
    }
    return this.client_.unaryCall(
    this.hostname_ +
