...
goog.object.extend(proto, mlmbox_types_notification_pb);
goog.exportSymbol('proto.mlmbox.client.account.GenerateAvaFilesRequest', null, global);
 ...
 * @constructor
 */
proto.mlmbox.client.account.GenerateAvaFilesRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.mlmbox.client.account.GenerateAvaFilesRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.mlmbox.client.account.GenerateAvaFilesRequest.displayName = 'proto.mlmbox.client.account.GenerateAvaFilesRequest';
}
 ...
 * @return {!Object}
 */
proto.mlmbox.client.account.GenerateAvaFilesRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.mlmbox.client.account.GenerateAvaFilesRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.mlmbox.client.account.GenerateAvaFilesRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.mlmbox.client.account.GenerateAvaFilesRequest}
 */
proto.mlmbox.client.account.GenerateAvaFilesRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.mlmbox.client.account.GenerateAvaFilesRequest;
  return proto.mlmbox.client.account.GenerateAvaFilesRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.mlmbox.client.account.GenerateAvaFilesRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.mlmbox.client.account.GenerateAvaFilesRequest}
 */
proto.mlmbox.client.account.GenerateAvaFilesRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.mlmbox.client.account.GenerateAvaFilesRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.mlmbox.client.account.GenerateAvaFilesRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.mlmbox.client.account.GenerateAvaFilesRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.mlmbox.client.account.GenerateAvaFilesRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.mlmbox.client.account.GenerateAvaFilesRequest.prototype.getMaleQuantity = function() {
...
/**
 * @param {number} value
 * @return {!proto.mlmbox.client.account.GenerateAvaFilesRequest} returns this
 */
proto.mlmbox.client.account.GenerateAvaFilesRequest.prototype.setMaleQuantity = function(value) {
 ...
 * @return {number}
 */
proto.mlmbox.client.account.GenerateAvaFilesRequest.prototype.getFemaleQuantity = function() {
 ...
 * @return {!proto.mlmbox.client.account.GenerateAvaFilesRequest} returns this
 */
proto.mlmbox.client.account.GenerateAvaFilesRequest.prototype.setFemaleQuantity = function(value) {
