 ...
 */
const methodDescriptor_Wallet_TransferRecipientsHistory = new grpc.web.MethodDescriptor(
 ...
 *     The XHR Node Readable Stream
 */
proto.mlmbox.client.finance.WalletClient.prototype.transferRecipientsHistory =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/mlmbox.client.finance.Wallet/TransferRecipientsHistory',
      request,
      metadata || {},
      methodDescriptor_Wallet_TransferRecipientsHistory,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.mlmbox.client.finance.WalletPromiseClient.prototype.transferRecipientsHistory =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/mlmbox.client.finance.Wallet/TransferRecipientsHistory',
      request,
