...
/**
 * optional mlmbox.types.Asset.Id asset_id = 1;
 ...
 * @return {!proto.mlmbox.client.finance.WalletAssetGetRequest} returns this
 */
proto.mlmbox.client.finance.WalletAssetGetRequest.prototype.clearAssetId = function() {
 ...
 * @return {boolean}
 */
proto.mlmbox.client.finance.WalletAssetGetRequest.prototype.hasAssetId = function() {
 ...
 * @return {!proto.mlmbox.client.finance.WalletAssetTransactionListRequest} returns this
 */
proto.mlmbox.client.finance.WalletAssetTransactionListRequest.prototype.clearAssetId = function() {
  return this.setAssetId(undefined);
};
 ...
 * @return {boolean}
 */
proto.mlmbox.client.finance.WalletAssetTransactionListRequest.prototype.hasAssetId = function() {
  return jspb.Message.getField(this, 1) != null;
};
...
proto.mlmbox.client.finance.WalletValidateAddressRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new mlmbox_types_wallet_pb.Wallet.Processing.Id;
      reader.readMessage(value,mlmbox_types_wallet_pb.Wallet.Processing.Id.deserializeBinaryFromReader);
...
proto.mlmbox.client.finance.WalletValidateAddressRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      mlmbox_types_wallet_pb.Wallet.Processing.Id.serializeBinaryToWriter
    );
  }
  f = message.getAddress();
  if (f.length > 0) {
...
/**
 * optional mlmbox.types.Wallet.Processing.Id processing_id = 1;
...
proto.mlmbox.client.finance.WalletValidateAddressRequest.prototype.getProcessingId = function() {
  return /** @type{?proto.mlmbox.types.Wallet.Processing.Id} */ (
    jspb.Message.getWrapperField(this, mlmbox_types_wallet_pb.Wallet.Processing.Id, 1));
};
 ...
 * @return {!proto.mlmbox.client.finance.WalletValidateAddressRequest} returns this
 */
proto.mlmbox.client.finance.WalletValidateAddressRequest.prototype.clearProcessingId = function() {
 ...
 * @return {boolean}
 */
proto.mlmbox.client.finance.WalletValidateAddressRequest.prototype.hasProcessingId = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {!proto.mlmbox.client.finance.WalletWithdrawalRequest} returns this
 */
proto.mlmbox.client.finance.WalletWithdrawalRequest.prototype.clearProcessingId = function() {
  return this.setProcessingId(undefined);
};
 ...
 * @return {boolean}
 */
proto.mlmbox.client.finance.WalletWithdrawalRequest.prototype.hasProcessingId = function() {
  return jspb.Message.getField(this, 1) != null;
};
