...
goog.exportSymbol('proto.mlmbox.client.network.TeamTopRequest', null, global);
/**
 ...
 * @constructor
 */
proto.mlmbox.client.network.TeamTopRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.mlmbox.client.network.TeamTopRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.mlmbox.client.network.TeamTopRequest.displayName = 'proto.mlmbox.client.network.TeamTopRequest';
}
 ...
 */
proto.mlmbox.client.network.TeamResponse.prototype.getSponsorsList = function() {
 ...
 * @return {!proto.mlmbox.client.network.TeamResponse} returns this
*/
proto.mlmbox.client.network.TeamResponse.prototype.setSponsorsList = function(value) {
 ...
 * @return {!proto.mlmbox.types.Account.Info}
 */
proto.mlmbox.client.network.TeamResponse.prototype.addSponsors = function(opt_value, opt_index) {
 ...
 * @return {!proto.mlmbox.client.network.TeamResponse} returns this
 */
proto.mlmbox.client.network.TeamResponse.prototype.clearSponsorsList = function() {
...
proto.mlmbox.client.network.TeamPartnerListRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      var value = /** @type {number} */ (reader.readUint32());
      msg.setStepSponsorBranch(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.mlmbox.client.network.TeamPartnerListRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getStepSponsorBranch();
  if (f !== 0) {
    writer.writeUint32(
      2,
      f
...
/**
 * optional uint32 step_sponsor_branch = 2;
 * @return {number}
 */
proto.mlmbox.client.network.TeamPartnerListRequest.prototype.getStepSponsorBranch = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.mlmbox.client.network.TeamPartnerListRequest} returns this
 */
proto.mlmbox.client.network.TeamPartnerListRequest.prototype.setStepSponsorBranch = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {!Object}
 */
proto.mlmbox.client.network.TeamTopRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.mlmbox.client.network.TeamTopRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.mlmbox.client.network.TeamTopRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.mlmbox.client.network.TeamTopRequest}
 */
proto.mlmbox.client.network.TeamTopRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.mlmbox.client.network.TeamTopRequest;
  return proto.mlmbox.client.network.TeamTopRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.mlmbox.client.network.TeamTopRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.mlmbox.client.network.TeamTopRequest}
 */
proto.mlmbox.client.network.TeamTopRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.mlmbox.client.network.TeamTopRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.mlmbox.client.network.TeamTopRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.mlmbox.client.network.TeamTopRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.mlmbox.client.network.TeamTopRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getViewPartner();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.mlmbox.types.Account.Id}
 */
proto.mlmbox.client.network.TeamTopRequest.prototype.getViewPartner = function() {
  return /** @type{?proto.mlmbox.types.Account.Id} */ (
    jspb.Message.getWrapperField(this, mlmbox_types_account_pb.Account.Id, 1));
};
...
/**
 * @param {?proto.mlmbox.types.Account.Id|undefined} value
 * @return {!proto.mlmbox.client.network.TeamTopRequest} returns this
*/
proto.mlmbox.client.network.TeamTopRequest.prototype.setViewPartner = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.mlmbox.client.network.TeamTopRequest} returns this
 */
proto.mlmbox.client.network.TeamTopRequest.prototype.clearViewPartner = function() {
  return this.setViewPartner(undefined);
};
 ...
 * @return {boolean}
 */
proto.mlmbox.client.network.TeamTopRequest.prototype.hasViewPartner = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {?proto.mlmbox.types.Sort}
 */
proto.mlmbox.client.network.TeamTopRequest.prototype.getPartnersSort = function() {
  return /** @type{?proto.mlmbox.types.Sort} */ (
    jspb.Message.getWrapperField(this, mlmbox_types_sort_pb.Sort, 2));
};
 ...
 * @return {!proto.mlmbox.client.network.TeamTopRequest} returns this
*/
proto.mlmbox.client.network.TeamTopRequest.prototype.setPartnersSort = function(value) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.mlmbox.client.network.TeamTopRequest} returns this
 */
proto.mlmbox.client.network.TeamTopRequest.prototype.clearPartnersSort = function() {
  return this.setPartnersSort(undefined);
};
 ...
 * @return {boolean}
 */
proto.mlmbox.client.network.TeamTopRequest.prototype.hasPartnersSort = function() {
  return jspb.Message.getField(this, 2) != null;
};
