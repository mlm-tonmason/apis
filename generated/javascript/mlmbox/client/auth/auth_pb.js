...
goog.exportSymbol('proto.mlmbox.client.auth.TelegramWebLoginRequest', null, global);
 ...
 * @constructor
 */
proto.mlmbox.client.auth.TelegramWebLoginRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.mlmbox.client.auth.TelegramWebLoginRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.mlmbox.client.auth.TelegramWebLoginRequest.displayName = 'proto.mlmbox.client.auth.TelegramWebLoginRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.mlmbox.client.auth.TelegramWebLoginRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.mlmbox.client.auth.TelegramWebLoginRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.mlmbox.client.auth.TelegramWebLoginRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.mlmbox.client.auth.TelegramWebLoginRequest}
 */
proto.mlmbox.client.auth.TelegramWebLoginRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.mlmbox.client.auth.TelegramWebLoginRequest;
  return proto.mlmbox.client.auth.TelegramWebLoginRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.mlmbox.client.auth.TelegramWebLoginRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.mlmbox.client.auth.TelegramWebLoginRequest}
 */
proto.mlmbox.client.auth.TelegramWebLoginRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.mlmbox.client.auth.TelegramWebLoginRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.mlmbox.client.auth.TelegramWebLoginRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.mlmbox.client.auth.TelegramWebLoginRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.mlmbox.client.auth.TelegramWebLoginRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getChannelId();
  if (f !== 0) {
    writer.writeUint32(
 ...
 * @return {number}
 */
proto.mlmbox.client.auth.TelegramWebLoginRequest.prototype.getChannelId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
 ...
 */
proto.mlmbox.client.auth.TelegramWebLoginRequest.prototype.setChannelId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
...
proto.mlmbox.client.auth.AuthSignResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = /** @type {!proto.mlmbox.types.Status.Sponsor} */ (reader.readEnum());
...
/**
 * optional mlmbox.types.Status.Sponsor referral_status = 2;
 * @return {!proto.mlmbox.types.Status.Sponsor}
 */
proto.mlmbox.client.auth.AuthSignResponse.prototype.getReferralStatus = function() {
  return /** @type {!proto.mlmbox.types.Status.Sponsor} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/**
 * @param {!proto.mlmbox.types.Status.Sponsor} value
 * @return {!proto.mlmbox.client.auth.AuthSignResponse} returns this
 */
