 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.mlmbox.client.auth.TelegramWebLoginRequest,
 *   !proto.mlmbox.client.auth.AuthSignResponse>}
 */
const methodDescriptor_Auth_TelegramWebLogin = new grpc.web.MethodDescriptor(
  '/mlmbox.client.auth.Auth/TelegramWebLogin',
  grpc.web.MethodType.UNARY,
  proto.mlmbox.client.auth.TelegramWebLoginRequest,
  proto.mlmbox.client.auth.AuthSignResponse,
  /**
   * @param {!proto.mlmbox.client.auth.TelegramWebLoginRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
...
/**
 * @param {!proto.mlmbox.client.auth.TelegramWebLoginRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.mlmbox.client.auth.AuthSignResponse)}
 ...
 *     The XHR Node Readable Stream
 */
proto.mlmbox.client.auth.AuthClient.prototype.telegramWebLogin =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/mlmbox.client.auth.Auth/TelegramWebLogin',
      request,
      metadata || {},
      methodDescriptor_Auth_TelegramWebLogin,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.mlmbox.client.auth.AuthPromiseClient.prototype.telegramWebLogin =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/mlmbox.client.auth.Auth/TelegramWebLogin',
      request,
