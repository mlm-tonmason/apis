 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.mlmbox.types.Matrix.Reinvest,
 *   !proto.google.protobuf.Empty>}
 */
const methodDescriptor_Matrix_SetReinvestConfig = new grpc.web.MethodDescriptor(
  ...
  grpc.web.MethodType.UNARY,
  mlmbox_types_account_pb.Matrix.Reinvest,
  google_protobuf_empty_pb.Empty,
  /**
   * @param {!proto.mlmbox.types.Matrix.Reinvest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
...
/**
 * @param {!proto.mlmbox.types.Matrix.Reinvest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
