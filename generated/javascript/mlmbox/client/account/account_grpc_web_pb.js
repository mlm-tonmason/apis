 ...
 */
const methodDescriptor_Account_SetSponsor = new grpc.web.MethodDescriptor(
 ...
 *     The XHR Node Readable Stream
 */
proto.mlmbox.client.account.AccountClient.prototype.setSponsor =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/mlmbox.client.account.Account/SetSponsor',
      request,
      metadata || {},
      methodDescriptor_Account_SetSponsor,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.mlmbox.client.account.AccountPromiseClient.prototype.setSponsor =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/mlmbox.client.account.Account/SetSponsor',
      request,
