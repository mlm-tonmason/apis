 ...
 */
const methodDescriptor_Account_SetProfileAva = new grpc.web.MethodDescriptor(
  '/mlmbox.client.account.Account/SetProfileAva',
  grpc.web.MethodType.UNARY,
 ...
 *     The XHR Node Readable Stream
 */
proto.mlmbox.client.account.AccountClient.prototype.setProfileAva =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/mlmbox.client.account.Account/SetProfileAva',
      request,
      metadata || {},
      methodDescriptor_Account_SetProfileAva,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.mlmbox.client.account.AccountPromiseClient.prototype.setProfileAva =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/mlmbox.client.account.Account/SetProfileAva',
      request,
