 ...
 * @const
 */
proto.mlmbox.types.Scheme.repeatedFields_ = [1,2,3,4,5,6];
...
/**
 * repeated Matrix.Tree matrix_trees = 6;
...
proto.mlmbox.types.Scheme.prototype.getMatrixTreesList = function() {
  return /** @type{!Array<!proto.mlmbox.types.Matrix.Tree>} */ (
    jspb.Message.getRepeatedWrapperField(this, mlmbox_types_account_pb.Matrix.Tree, 6));
};
...
proto.mlmbox.types.Scheme.prototype.addMatrixTrees = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 6, opt_value, proto.mlmbox.types.Matrix.Tree, opt_index);
};
