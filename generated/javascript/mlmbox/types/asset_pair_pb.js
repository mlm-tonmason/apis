...
goog.exportSymbol('proto.mlmbox.types.AssetPair.List', null, global);
/**
 ...
 * @constructor
 */
proto.mlmbox.types.AssetPair.List = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.mlmbox.types.AssetPair.List.repeatedFields_, null);
};
goog.inherits(proto.mlmbox.types.AssetPair.List, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.mlmbox.types.AssetPair.List.displayName = 'proto.mlmbox.types.AssetPair.List';
}
 ...
 * @const
 */
proto.mlmbox.types.AssetPair.List.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.mlmbox.types.AssetPair.List.prototype.toObject = function(opt_includeInstance) {
  return proto.mlmbox.types.AssetPair.List.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.mlmbox.types.AssetPair.List} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.mlmbox.types.AssetPair.List}
 */
proto.mlmbox.types.AssetPair.List.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.mlmbox.types.AssetPair.List;
  return proto.mlmbox.types.AssetPair.List.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.mlmbox.types.AssetPair.List} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.mlmbox.types.AssetPair.List}
 */
proto.mlmbox.types.AssetPair.List.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.mlmbox.types.AssetPair;
      reader.readMessage(value,proto.mlmbox.types.AssetPair.deserializeBinaryFromReader);
      msg.addItems(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.mlmbox.types.AssetPair.List.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.mlmbox.types.AssetPair.List.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.mlmbox.types.AssetPair.List} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.mlmbox.types.AssetPair.List.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.mlmbox.types.AssetPair.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.mlmbox.types.AssetPair>}
 */
proto.mlmbox.types.AssetPair.List.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.mlmbox.types.AssetPair>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.mlmbox.types.AssetPair, 1));
};


/**
 * @param {!Array<!proto.mlmbox.types.AssetPair>} value
 * @return {!proto.mlmbox.types.AssetPair.List} returns this
*/
proto.mlmbox.types.AssetPair.List.prototype.setItemsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.mlmbox.types.AssetPair=} opt_value
 * @param {number=} opt_index
 * @return {!proto.mlmbox.types.AssetPair}
 */
proto.mlmbox.types.AssetPair.List.prototype.addItems = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.mlmbox.types.AssetPair, opt_index);
};
 ...
 * @return {!proto.mlmbox.types.AssetPair.List} returns this
 */
proto.mlmbox.types.AssetPair.List.prototype.clearItemsList = function() {
